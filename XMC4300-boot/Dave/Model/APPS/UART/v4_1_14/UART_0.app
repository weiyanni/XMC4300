...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="UART" URI="http://resources/4.1.14/app/UART/0" description="UART APP configures a USIC channel to perform &#xA;transmit &amp; receive operations using UART protocol." mode="NOTSHARABLE" version="4.1.14" minDaveVersion="4.0.0" instanceLabel="UART_485" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_transmit_buffer" URI="http://resources/4.1.14/app/UART/0/vs_uart_std_tx_int" hwSignal="transmit_buffer_int" hwResource="//@hwResources.0"/>
  ...
  <virtualSignals name="destination_trigger" URI="http://resources/4.1.14/app/UART/0/vs_dst_trigger_dlr_tx_in" hwSignal="in" hwResource="//@hwResources.8"/>
  ...
  <virtualSignals name="dlr_out" URI="http://resources/4.1.14/app/UART/0/vs_dst_trigger_dlr_tx_out" hwSignal="out" hwResource="//@hwResources.8"/>
  <virtualSignals name="DMA Transfer complete event" URI="http://resources/4.1.14/app/UART/0/vs_dma_interrupt_tx" hwSignal="dma_int" hwResource="//@hwResources.6"/>
  ...
  <virtualSignals name="Destination request" URI="http://resources/4.1.14/app/UART/0/vs_dma_ch_dst_req_tx" hwSignal="dest_req" hwResource="//@hwResources.6"/>
  ...
  <requiredApps URI="http://resources/4.1.14/app/UART/0/appres_global_dma" requiredAppName="GLOBAL_DMA" requiringMode="SHARABLE">
  ...
  <hwResources name="NVIC Node Rx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_rx" resourceGroupUri="resources/43.0.0/peripheral/cpu/0/nvic/interrupt/90" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
  ...
  <hwResources name="DMA channel Tx" URI="http://resources/4.1.14/app/UART/0/hwres_dma_ch_tx" resourceGroupUri="resources/48.0.0/peripheral/dma8/0/ch/5" solverVariable="true" mResGrpUri="peripheral/sv0/0/ch/*">
  ...
  <hwResources name="DLR channel Tx" URI="http://resources/4.1.14/app/UART/0/hwres_dlr_ch_tx" resourceGroupUri="resources/48.0.0/peripheral/dlr/0/ch/2" mResGrpUri="peripheral/dlr/0/ch/*">
